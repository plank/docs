...
slug: publisher/13.x/advanced/schema-conflicts
---
...
- [Installation](/publisher/13.x/guides/installation/) - Initial setup
- [Draft Management](/publisher/13.x/features/draft-management/) - How drafts work
- [Plank Ecosystem](/publisher/13.x/advanced/plank-ecosystem/) - Related packages
