...
slug: publisher/13.x/advanced/admin-panel-integration
---
...
- [Middleware](/publisher/13.x/features/middleware/) - Draft path configuration
- [Authorization](/publisher/13.x/features/authorization/) - Gates for admin
- [URL Rewriting](/publisher/13.x/features/url-rewriting/) - Preview links
