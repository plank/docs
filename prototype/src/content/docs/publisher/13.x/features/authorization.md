---
title: "Authorization"
slug: publisher/13.x/features/authorization
---
...
- [Middleware](/publisher/13.x/features/middleware/) - Request-level authorization
- [Publishing Workflow](/publisher/13.x/features/publishing-workflow/) - When gates are checked
- [Admin Panel Integration](/publisher/13.x/advanced/admin-panel-integration/) - Panel-specific auth
